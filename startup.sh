...
then
    ...
    java -Djava.security.egd=file:/dev/./urandom -jar /app.jar --spring.profiles.active=test
...
then
    ...
    java -Djava.security.egd=file:/dev/./urandom -jar /app.jar --spring.profiles.active=dev
fi
